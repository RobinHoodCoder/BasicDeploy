...
/*gulp.task('styles', function () {
  ...
  return gulp.src(['site/css/reset.css', CSS_PATH])
...
gulp.task('styles', function () {
    ...
    return gulp.src('./site/styles/less/bootstrap.less')
        .pipe(plumber(function (err) {
            console.log('Styles Task Error');
            console.log(err);
            // this.emit('end');
...
gulp.task('templates', function () {
    ...
    // Calls the gulp-handlebars library to compile as handlebars templates
        ...
        // 2 of 2 -Save concatenated+minified file into site/dist directory
        .pipe(gulp.dest(DIST_PATH))
        // livereload - listens to the site/dist directory for changes
        .pipe(livereload());
});
